...
public class WoodyAgent_2acts : Agent
{
    //------------------------------------------------------------------------------------------
    ...
    public WoodyAgent_2acts otheragent;
    ...
    void TakeAction1(ActionSegment<float> vectoraction)
    {
        ...
        leftforce = new Vector3(0f, vectoraction[0]*10f, 0f);
        rightforce = new Vector3(0f, vectoraction[1]*10f, 0f);
    ...
    void TakeAction2(ActionSegment<float> vectoraction)
    {
        ...
        leftforce = new Vector3(0f, vectoraction[0], 0f);
        rightforce = new Vector3(0f, vectoraction[1], 0f);
        ...
        // Debug.Log("l1 velocity: " + l1.GetComponent<Rigidbody>().velocity.ToString("F3"));
        // Debug.Log("r1 velocity: " + r1.GetComponent<Rigidbody>().velocity.ToString("F3"));
        // Debug.Log("board velocity: " + boardrigid.velocity.ToString("F3"));
    }
    ...
    void TakeAction3(ActionSegment<float> vectoraction)
    {
        ...
        l1.position = new Vector3(0f, vectoraction[0]*1f, 0f);
        r1.position = new Vector3(0f, vectoraction[1]*1f, 0f);
    }
    ...
    void SetResetParameters()
    {
        ...
        board_dense_reward_index = m_ResetParams.GetWithDefault("board_dense_reward_index", 7f);
    ...
    {
       if (action[0] > 0) Debug.Log(this.name + " Q pressed, l1 Y force increased" + " " + action[0] + " " + l1.position.ToString("F3"));
       if (action[0] < 0) Debug.Log(this.name + " A pressed, l1 Y force decreased" + " " + action[0] + " " + l1.position.ToString("F3"));
       if (action[1] > 0) Debug.Log(this.name + " W pressed, r1 Y force increased" + " " + action[1] + " " + r1.position.ToString("F3"));
       if (action[1] < 0) Debug.Log(this.name + " S pressed, r1 Y force decreased" + " " + action[1] + " " + r1.position.ToString("F3"));
